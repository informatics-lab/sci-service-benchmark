...
get_ipython().getoutput('s3fs mogreps-g /usr/local/share/notebooks/data/mogreps-g -o iam_role=jade-secrets')


# In[10]:

get_ipython().getoutput('jupyter nbconvert --to script monthly_climate.ipynb')
